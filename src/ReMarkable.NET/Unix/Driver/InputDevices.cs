...
namespace ReMarkable.NET.Unix.Driver
{
    ...
    public static class InputDevices
    {
        ...
        public static readonly IKeyboardDriver Keyboard;
            ...
            switch (DeviceType.GetDevice())
            {
                case Device.Emulator:
                    ...
                    if (deviceContainer != null)
                    {
                        ...
                        deviceContainer.ReadStaticField("Keyboard", out Keyboard);
                    }
                    break;
                case Device.RM1:
                ...
                case Device.RM2:
                    ...
                    if (rm2DeviceMap.ContainsKey("rM_Keyboard"))
                    {
                        Keyboard = new HardwareKeyboardDriver(rm2DeviceMap["rM_Keyboard"]);
                    }
